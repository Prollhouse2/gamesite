...
const HOLIDAY_RESOURCE_INDEX = 68;
...
class WorldResource 
{
    ...
    totalValue()
    {
        return this.sellValue.multiply(this.numOwned);
    }
}
...
coal.name = _("Coal");
coal.sellValue = new BigNumber(1);
...
copper.sellValue = new BigNumber(2);
...
silver.sellValue = new BigNumber(4);
...
gold.name = _("Gold");
gold.sellValue = new BigNumber(16);
...
platinum.index = PLATINUM_INDEX;
platinum.name = _("Platinum");
platinum.sellValue = new BigNumber(32);
...
diamond.sellValue = new BigNumber(64);
...
coltan.sellValue = new BigNumber(500);
...
painite.sellValue = new BigNumber(1000);
...
blackOpal.sellValue = new BigNumber(2000);
...
redDiamond.sellValue = new BigNumber(10000);
...
blueObsidian.sellValue = new BigNumber(20000);
...
californium.sellValue = new BigNumber(100000);
...
carbon.sellValue = new BigNumber(500000);
...
iron.name = _("Iron");
iron.sellValue = new BigNumber(1000000);
...
aluminum.sellValue = new BigNumber(2000000);
...
magnesium.sellValue = new BigNumber(5000000);
...
titanium.sellValue = new BigNumber(750000000);
...
silicon.sellValue = new BigNumber(100000000);
...
promethium.sellValue = new BigNumber(1400000000);
...
neodymium.sellValue = new BigNumber(10000000000);
...
ytterbium.sellValue = new BigNumber(50000000000);
...
uranium1.sellValue = new BigNumber(100);
...
uranium2.sellValue = new BigNumber(2000);
...
uranium3.sellValue = new BigNumber(50000);
...
plutonium1.sellValue = new BigNumber(1000);
...
plutonium2.sellValue = new BigNumber(20000);
...
plutonium3.sellValue = new BigNumber(500000);
...
polonium1.sellValue = new BigNumber(5000);
...
polonium2.sellValue = new BigNumber(250000);
...
polonium3.sellValue = new BigNumber(50000000);
...
nitrogen1.sellValue = new BigNumber(50000000);
...
nitrogen2.sellValue = new BigNumber(150000000);
...
nitrogen3.sellValue = new BigNumber(300000000);
...
helium1.sellValue = new BigNumber(500000000);
...
helium2.sellValue = new BigNumber(5000000000);
...
helium3.sellValue = new BigNumber(500000000000);
...
oilResource.sellValue = new BigNumber(0);
...
redForgedGem.sellValue = new BigNumber(0);
...
blueForgedGem.sellValue = new BigNumber(0);
...
greenForgedGem.sellValue = new BigNumber(0);
...
purpleForgedGem.sellValue = new BigNumber(0);
...
yellowForgedGem.sellValue = new BigNumber(0);
...
forgeCatalystResource.sellValue = new BigNumber(0);
...
storedNuclearEnergy.sellValue = new BigNumber(0);
...
einsteinium1.sellValue = new BigNumber(550000000000);
...
einsteinium2.sellValue = new BigNumber(5500000000000);
...
einsteinium3.sellValue = new BigNumber(550000000000000);
...
buildingMaterials.sellValue = new BigNumber(0);
...
fermium1.sellValue = new BigNumber(66600000000000);
...
fermium2.sellValue = new BigNumber(246000000000000);
...
fermium3.sellValue = new BigNumber(6960000000000000);
...
hydrogen1.sellValue = new BigNumber(50000000000000);
...
hydrogen2.sellValue = new BigNumber(500000000000000);
...
hydrogen3.sellValue = new BigNumber(5000000000000000);
...
oxygen1.sellValue = new BigNumber(66600000000000);
...
oxygen2.sellValue = new BigNumber(666000000000000);
...
oxygen3.sellValue = new BigNumber(6660000000000000);
...
tin.index = TIN_INDEX;
tin.name = _("Tin");
tin.sellValue = new BigNumber(500000000000);
tin.isIsotope = false;
...
sulfur.sellValue = new BigNumber(2500000000000);
...
lithium.sellValue = new BigNumber(10000000000000);
...
manganese.sellValue = new BigNumber(750000000000000);
...
mercury.sellValue = new BigNumber(7500000000000000);
...
nickel.sellValue = new BigNumber(250000000000000);
...
alexandrite.sellValue = new BigNumber(250000000000000);
...
benitoite.sellValue = new BigNumber(250000000000000);
...
cobalt.sellValue = new BigNumber(250000000000000);
...
superMinerSouls.sellValue = new BigNumber(0);
...
var holidayResource = new WorldResource();
holidayResource.index = HOLIDAY_RESOURCE_INDEX;
holidayResource.name = _("Holiday Resource");
holidayResource.sellValue = new BigNumber(0);
holidayResource.isIsotope = false;
holidayResource.isOnHeader = false;
holidayResource.isotopeIndex = 0;
holidayResource.indexOfWorldEncountered = EARTH_INDEX;
holidayResource.smallIcon = darkdot;
holidayResource.smallIconHidden = darkdot;
holidayResource.largeIcon = darkdot;
holidayResource.largeIconHidden = darkdot;
holidayResource.isTradable = false;
worldResources[HOLIDAY_RESOURCE_INDEX] = holidayResource;
...
var mineralsMinedValue = new BigNumber(0);
var mineralsSoldValue = new BigNumber(0);
...
function mine()
{
    ...
    if(!isCapacityFull())
    {
            ...
            if(((workersHiredAtDepth(x) * 2) + (workerLevelForDepth * 3)) > rand(0, 39))
            {
                for(var y = 0; y < levels[x].length; y++)
                {
                    ...
                    if(rand(0, 999) < threshold)
                    {
                        ...
                        totalMineralsMined++;
                        mineralsMinedValue = mineralsMinedValue.add(worldResources[mineralIndex].sellValue);
                        capacity++;
        ...
        {
            singleMiningLoopValueSnapshot.push(getValueOfMineralsExcludingHe3().subtract(valueBefore));
...
function valueOfMineralsPerSecond(useSuperMinerMultiplier = true)
{
    ...
    var mineralValue = new BigNumber();

    for(var key in mineralsMined)
    {
        mineralValue = mineralValue.add(worldResources[key].sellValue.multiply(mineralsMined[key]));
    }
...
function sellMineralAmount(x, amount)
{
    ...
    if(amount > 0)
    {
        ...
        let profit = worldResources[x].sellValue.multiply(amount).multiply(sellPriceMultiplier);

        if(relicFunctionalityRoller.rand(0, 100) < STAT.percentChanceOfSellingFor2x())
        {
            profit = profit.multiply(2);
        }
...
function sellMineral(x)
{
    ...
    if(sale.amountToSell > 0)
    {
        if(relicFunctionalityRoller.rand(0, 100) < STAT.percentChanceOfSellingFor2x())
        {
            sale.profit = sale.profit.multiply(2);
        ...
        mineralsSoldValue = mineralsSoldValue.add(sale.profit);
...
function getMineralSaleStats(x)
{
    ...
    let saleProfit = worldResources[x].sellValue.multiply(amountToSell).multiply(sellPriceMultiplier);
...
function sellAllMinerals(tab)
{
    ...
    var moneyPriorToSale = new BigNumber(money);
    ...
    var totalSaleProceeds = money.subtract(moneyPriorToSale);
    if(totalSaleProceeds.greaterThan(100000000000000000))
    {
...
function getValueOfMinerals()
{
    ...
    {
        totalValue = totalValue.add(worldResources[i].totalValue());
    }

    return totalValue.multiply(sellPriceMultiplier);
}
...
function numHolidayResourcesOwned()
{
    return worldResources[HOLIDAY_RESOURCE_INDEX].numOwned;
}