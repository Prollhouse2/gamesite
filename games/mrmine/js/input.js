    ...
    if(tickets > 0)
    {
        showConfirmationPrompt(
            ...
            function ()
            {
                ...
                hideSimpleInput();
                tickets--;
                trackEvent_SpentTickets(1, ShopCategories.INGAME_PURCHASE, 0);
            },
            _("Cancel"));
    }
    else
    ...
    if(tickets > 0)
    {
        showConfirmationPrompt(
            ...
            function ()
            {
                ...
                hideSimpleInput();
                tickets--;
                trackEvent_SpentTickets(1, ShopCategories.INGAME_PURCHASE, 1);
            },
            _("Cancel"));
    }
    else
...
function rerollExcavations()
{
    if(tickets > 0 && tempConfirmRerollIndex > -1)
    {
        ...
        if(!isOnActiveExcavation(scientistIndex) && !isScientistDead(scientistIndex))
        {
            ...
            trackEvent_SpentTickets(1, ShopCategories.INGAME_PURCHASE, 2);
        }
    }
}
