class Scrollbox extends Hitbox
{
    ...
    render()
    {
        ...
        var sourceImageWidth = this.canvas.width;
        var sourceImageHeight = this.boundingBox.height / this.scale;
        var renderedImageWidth = this.boundingBox.width - this.scrollbarWidth;
        var renderedImageHeight = this.boundingBox.height;
        if (sourceImageHeight > this.canvas.height)
        {
            sourceImageHeight = this.canvas.height;
            renderedImageHeight = sourceImageHeight * renderedImageWidth / sourceImageWidth;
        }
