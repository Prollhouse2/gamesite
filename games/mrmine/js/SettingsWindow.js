class SettingsWindow extends TabbedPopupWindow
{
    ...
    constructor(boundingBox, startTab = 0)
    {
        ...
        this.settingsPane.addHitbox(new Hitbox(
            ...
            },
            {
                ...
                onmouseenter: function ()
                {
                    showTooltip(_("Play on Mobile"), _("Click to checkout the mrmine android version. (iOS is coming soon.)"))
                },
                onmouseexit: function ()
                {
                    hideTooltip();
    ...
    renderStatsPanel()
    {
        ...
        saveCanvasState(context);
        context.fillText(_("Current Game Version") + ": " + "v" + ((version - 100) / 100) + "." + buildLetter + "." + splitTestValue1, this.boundingBox.width * .01, this.boundingBox.height * .87);
        context.fillText(_("Total Minerals Mined") + ": " + beautifynum(totalMineralsMined), this.boundingBox.width * .01, this.boundingBox.height * .94);
        context.fillText(_("Total Basic Chests Opened") + ": " + beautifynum(chestService.totalBasicChestsOpened), this.boundingBox.width * .01, this.boundingBox.height * 1.01);
        context.fillText(_("Total Gold Chests Opened") + ": " + beautifynum(chestService.totalGoldChestsOpened), this.boundingBox.width * .01, this.boundingBox.height * 1.08);
        context.fillText(_("Total Ethereal Chests Opened") + ": " + beautifynum(chestService.totalBlackChestsOpened), this.boundingBox.width * .01, this.boundingBox.height * 1.15);
        context.fillText(_("Highest Level Scientist Ever") + ": " + beautifynum(highestLevelScientist), this.boundingBox.width * .01, this.boundingBox.height * 1.22);
        context.fillText(_("Scientists Buried") + ": " + beautifynum(deadScientists), this.boundingBox.width * .01, this.boundingBox.height * 1.29);
        context.fillText(_("Monsters Killed") + ": " + beautifynum(monsterskilled), this.boundingBox.width * .01, this.boundingBox.height * 1.36);
        context.fillText(_("Minerals Sacrificed") + ": " + beautifynum(mineralsSacrificed), this.boundingBox.width * .01, this.boundingBox.height * 1.43);
        context.fillText(_("Total Trades Done") + ": " + beautifynum(totalCompletedTrades), this.boundingBox.width * .01, this.boundingBox.height * 1.50);
        context.fillText(_("Total Time Lapsed") + ": " + shortenedFormattedTime(totalTimeLapsedMinutes * 60), this.boundingBox.width * .01, this.boundingBox.height * 1.57);
        context.fillText(_("Total Time Lapsed This Session") + ": " + shortenedFormattedTime(timelapseMinutesInSession * 60), this.boundingBox.width * .01, this.boundingBox.height * 1.64);
        context.fillText(_("Total Money Earned This Session") + ": " + beautifynum(totalMoneyEarnedSession), this.boundingBox.width * .01, this.boundingBox.height * 1.71);
        context.fillText(_("Value of Minerals Mined This Session") + ": " + beautifynum(mineralsMinedValue), this.boundingBox.width * .01, this.boundingBox.height * 1.78);
        context.fillText(_("Value of Minerals Sold This Session") + ": " + beautifynum(mineralsSoldValue), this.boundingBox.width * .01, this.boundingBox.height * 1.85);
        context.fillText(_("Total Money Collected from Chests This Session") + ": " + beautifynum(chestService.totalMoneyFromChests), this.boundingBox.width * .01, this.boundingBox.height * 1.92);
        context.fillText(_("Session Duration") + ": " + shortenedFormattedTime(performance.now() / 1000), this.boundingBox.width * .01, this.boundingBox.height * 1.99);
        restoreCanvasState(context);
    }
}