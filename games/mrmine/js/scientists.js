...
var excavationRewards = [
    ...
    {"id": 6, "name": _("2x Tickets"), "description": _("2 Tickets"), "image": ticketicon, "rarity": .62, "isRelic": false, "grantFunction": function () {addTickets(2, "excavation");}, "isCandidateFunction": alwaysTrue, "relatedIndexesForSacrifice": [], "renderFunction": standardRelicRenderFunction, "hasRewardScaling": false},
    ...
    {"id": 40, "name": _("1 Ticket"), "description": _("1 Ticket"), "image": ticketicon, "rarity": .4, "isRelic": false, "grantFunction": function () {tickets++;}, "isCandidateFunction": alwaysTrue, "relatedIndexesForSacrifice": [], "renderFunction": standardRelicRenderFunction, "hasRewardScaling": false},
    ...
    {"id": 123, "name": _("Fuel Extractor"), "statType": DRONE_FUEL_REGEN_MULTIPLIER, "amount": 7.5, "image": fuelRegen, "rarity": .65, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysTrue, "relatedIndexesForSacrifice": [126, 129], "renderFunction": standardRelicRenderFunction, "warpId": 124, "divineId": 125, "hasRewardScaling": false},
    {"id": 124, "name": _("Fuel Extractor") + "+", "statType": DRONE_FUEL_REGEN_MULTIPLIER, "amount": 10, "image": fuelRegen, "rarity": 1.65, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysFalse, "relatedIndexesForSacrifice": [127, 130], "renderFunction": warpedRelicRenderFunction, "warpId": 124, "divineId": 125, "hasRewardScaling": false},
    {"id": 125, "name": _("Fuel Extractor") + "++", "statType": DRONE_FUEL_REGEN_MULTIPLIER, "amount": 12.5, "image": fuelRegen, "rarity": 2.65, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysFalse, "relatedIndexesForSacrifice": [128, 131], "renderFunction": divineRelicRenderFunction, "warpId": 125, "divineId": 125, "hasRewardScaling": false},

    {"id": 126, "name": _("Fuel Tank"), "statType": DRONE_STARTING_FUEL_MULTIPLIER, "amount": 7.5, "image": startingFuel, "rarity": .65, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysTrue, "relatedIndexesForSacrifice": [123, 129], "renderFunction": standardRelicRenderFunction, "warpId": 127, "divineId": 128, "hasRewardScaling": false},
    {"id": 127, "name": _("Fuel Tank") + "+", "statType": DRONE_STARTING_FUEL_MULTIPLIER, "amount": 10, "image": startingFuel, "rarity": 1.65, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysFalse, "relatedIndexesForSacrifice": [124, 130], "renderFunction": warpedRelicRenderFunction, "warpId": 127, "divineId": 128, "hasRewardScaling": false},
    {"id": 128, "name": _("Fuel Tank") + "++", "statType": DRONE_STARTING_FUEL_MULTIPLIER, "amount": 12.5, "image": startingFuel, "rarity": 2.65, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysFalse, "relatedIndexesForSacrifice": [125, 131], "renderFunction": divineRelicRenderFunction, "warpId": 128, "divineId": 128, "hasRewardScaling": false},

    {"id": 129, "name": _("Rocket Booster"), "statType": DRONE_MOVEMENT_SPEED_MULTIPLIER, "amount": 7.5, "image": droneSpeed, "rarity": .75, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysTrue, "relatedIndexesForSacrifice": [126, 123], "renderFunction": standardRelicRenderFunction, "warpId": 130, "divineId": 131, "hasRewardScaling": false},
    {"id": 130, "name": _("Rocket Booster") + "+", "statType": DRONE_MOVEMENT_SPEED_MULTIPLIER, "amount": 10, "image": droneSpeed, "rarity": 1.75, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysFalse, "relatedIndexesForSacrifice": [127, 124], "renderFunction": warpedRelicRenderFunction, "warpId": 130, "divineId": 131, "hasRewardScaling": false},
    {"id": 131, "name": _("Rocket Booster") + "++", "statType": DRONE_MOVEMENT_SPEED_MULTIPLIER, "amount": 12.5, "image": droneSpeed, "rarity": 2.75, "isRelic": true, "grantFunction": null, "isCandidateFunction": alwaysFalse, "relatedIndexesForSacrifice": [128, 125], "renderFunction": divineRelicRenderFunction, "warpId": 131, "divineId": 131, "hasRewardScaling": false},
...
var scientists = [
    ...
    {"id": 14, "warpedId": 33, "name": "Layla", "rarity": _("Common"), "deathChanceMultiple": 1, "image": arch15, "blinkImage": arch15_blink, "additionalRewardCandidates": 0, "isNormal": true},
    ...
    {"id": 33, "warpedId": 33, "name": unicodeToStringCode(warpedLaylaName), "rarity": _("Warped"), "deathChanceMultiple": 0.75, "image": arch15w, "blinkImage": arch15w_blink, "additionalRewardCandidates": 1, "isNormal": false},
...
function startExcavation(scientistIndex, excavationChoiceIndex)
{
    ...
    var scientistRarity = scientistRarities[scientists[activeScientists[scientistIndex][0]].rarity];
        ...
        if(isScientistDead(scientistIndex))
        {
            if(tickets >= costToResurrect)
            {
                ...
                showConfirmationPrompt(
                    _("Are you sure you want to pay {0} tickets to resurrect {1}?", costToResurrect, staticScientist.name),
                    _("Yes"),
                    function ()
                    {
                        hideSimpleInput();
...
function testScientistDeathRate(scientistIdToGrant = 0, tests = 1000)
{
    ...
    for(var i = 0; i < tests; i++)
    {
        ...
        {
            if(activeExcavations[0].length > 1 && activeExcavations[0][3] != 0)
            {
            ...
            else
            {
                ...
                var activeExcavation = activeExcavations[0];
                var activeScientist = activeScientists[0];
                var staticScientist = scientists[activeScientist[0]];
                var experienceMultiplier = 2 - staticScientist.deathChanceMultiple;
