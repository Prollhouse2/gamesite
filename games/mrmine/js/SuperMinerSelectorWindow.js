class SuperMinerSelectorWindow extends PopupWindow
{
                    ...
                    if(superMinerManager.isFull())
                    {
                        showConfirmationPrompt(
                            ...
                            () =>
                            {
                                ...
                                {
                                    this.superMiner.grantSoulsFromScrap();
                                }
                                closeUi(this);
    ...
    render()
    {
        ...
        {
            this.superMiner.renderDescription(this.context, popupX + (popupWidth * 0.3), popupY + (popupHeight * .69), popupWidth * 0.65, popupHeight * 0.33);
        }
