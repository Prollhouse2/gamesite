...
var SCIENTIST_RESURRECTION_PERCENT_CHANCE = new stat(12, "Increases chance a scientist will immediately resurrect when killed by {0}%", STAT_OPERATION_INTEGER_ADD, 80);
...
var DRONE_FUEL_REGEN_MULTIPLIER = new stat(28, "Increases the speed that caves regen fuel by {0}%", STAT_OPERATION_DECIMAL_ADD);
var DRONE_STARTING_FUEL_MULTIPLIER = new stat(29, "Increases drones starting fuel by {0}%", STAT_OPERATION_DECIMAL_ADD);
var DRONE_MOVEMENT_SPEED_MULTIPLIER = new stat(30, "Increases drones movement speed by {0}%", STAT_OPERATION_DECIMAL_ADD);
var SUPER_MINER_SPEED = new stat(31, "Increases super miner performance by {0}%", STAT_OPERATION_DECIMAL_ADD, 1);
var MINERAL_DEPOSIT_AMOUNT_MULTIPLIER = new stat(32, "Increases the maximum number of minerals from a mineral deposit by {0}%", STAT_OPERATION_DECIMAL_ADD);
var ETHEREAL_CHEST_SPAWN_FREQUENCY_MULTIPLIER = new stat(33, "Increases the current spawn rate of Ethereal chests by {0}%", STAT_OPERATION_DECIMAL_SUBTRACT, .85);
