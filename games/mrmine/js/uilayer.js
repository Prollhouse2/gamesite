...
class NewWorldEntityHitbox extends Hitbox
{
    ...
    constructor(kmDepth, boundingBox, mouseEventFunctions, cursor, id = "")
    {
        // Create deep copy of boundingBox so we can refer to it later when we update the depth
    ...
    updateDepth(kmDepth)
    {
        ...
        this.boundingBox.y = this.originalBoundingBox.y + topBound + 
            ((kmDepth + Math.floor(worldConfig.numberOfDepthsVisible)) * levelHeight) / uiScaleY;
        this.kmDepth = kmDepth;
    }
}
