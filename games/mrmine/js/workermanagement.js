...
function hireMiner(worldIndex)
{
    ...
    if(worldReference.canHireWorker())
    {
        ...
        trackEvent_HireMiner(worldIndex, worldReference.workersHired, worldReference.workerLevel);
...
function upgradeMiners(worldIndex)
{
    ...
    if(worldReference.canUpgradeWorkersLevel())
    {
        ...
        trackEvent_UpgradeMiners(worldIndex, worldReference.workersHired, worldReference.workerLevel);
